...
if Manager(msg) then
if DevAli:get(ReLaXX.."Ali:Lock:ProNames"..msg.chat_id_) then
local Txt = text:match("^وضع توحيد (.*)$") or text:match("^ضع توحيد (.*)$")
send(msg.chat_id_, msg.id_,'⌁︙تم تعيين ↫ '..Txt..' كتوحيد للمجموعه')
DevAli:set(ReLaXX.."Ali:ProNames:Txt"..msg.chat_id_,Txt)
else
...
DevAli:set(ReLaXX.."Ali:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevAli:get(ReLaXX.."Ali:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevAli:get(ReLaXX.."Ali:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevAli:get(ReLaXX.."Ali:ProNames:Num"..msg.chat_id_) or 5
...
if DevAli:get(ReLaXX.."Ali:Lock:ProNames"..msg.chat_id_) and DevAli:get(ReLaXX.."Ali:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevAli:get(ReLaXX.."Ali:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevAli:srem(ReLaXX..'Ali:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevAli:get(ReLaXX.."Ali:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevAli:get(ReLaXX.."Ali:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(UserNum) == tonumber(ProNamesTxt) or tonumber(UserNum) > tonumber(ProNamesTxt)) then 
DevAli:sadd(ReLaXX..'Ali:Muted:'..msg.chat_id_, msg.sender_user_id_)
DevAli:del(ReLaXX.."Ali:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
DevAli:set(ReLaXX.."Ali:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌁︙تم تعطيل توحيد المجموعه')
DevAli:del(ReLaXX.."Ali:Lock:ProNames"..msg.chat_id_)
end
end
