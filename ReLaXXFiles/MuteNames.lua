...
if DevAli:get(ReLaXX.."Ali:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAli:sadd(ReLaXX.."Ali:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevAli:get(ReLaXX.."Ali:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
ReLaXXName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if ReLaXXName then 
ReLaXXNames = DevAli:smembers(ReLaXX.."Ali:Mute:Names"..msg.chat_id_) or ""
if ReLaXXNames and ReLaXXNames[1] then 
for i=1,#ReLaXXNames do 
if ReLaXXName:match("(.*)("..ReLaXXNames[i]..")(.*)") then 
...
DevAli:set(ReLaXX.."Ali:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAli:del(ReLaXX.."Ali:Lock:MuteNames"..msg.chat_id_)
end
end
end
